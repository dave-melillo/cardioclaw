...
async function init() {
  ...
  if (fs.existsSync(CONFIG_PATH)) {
    ...
    console.log('  1. Edit the file to add or modify your heartbeats');
    console.log('  2. Run: cardioclaw sync --dry-run  (preview changes)');
    console.log('  3. Run: cardioclaw sync             (apply changes)');
    console.log('  4. Run: cardioclaw status           (verify jobs)\n');
    process.exit(0);
  }
