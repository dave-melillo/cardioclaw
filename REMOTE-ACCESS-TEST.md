...
→ http://server.tailc2d261.ts.net:3333
...
**On workstation:**
- Open `http://server.tailc2d261.ts.net:3333` in browser
...
**Expected:**
- Binds to Tailscale IP (e.g., 100.121.185.78)
...
curl http://server.tailc2d261.ts.net:3333/api/status
...
- Tailscale detected: `outrider.tailc2d261.ts.net`
- IP: `100.121.185.78`
- Dashboard accessible at: `http://outrider.tailc2d261.ts.net:3333`
